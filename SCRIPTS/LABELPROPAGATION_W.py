...
filename = "D:/TESIS_PHD/RICENETPPI/CANDIDATES_COMBINED.csv"
...
results[["prob_1","prob_2"]] = prob_LP
results[["pred_1","pred_2"]] = prob_LP
results["final"] =0
...
for i in range(len(results["prob_2"])):
    if results["pred_2"][i] >= 0.9:
        results["pred_2"][i] = 1
    else:
        results["pred_2"][i] = 0
...
print(len(results["final"][results["final"]==2]))

#results.to_csv("D:/TESIS_PHD/RICENETPPI/out_pred.csv")
results.to_csv("D:/REPO_GITHUB/ALUMINUM_GENES_CLASSIFICATION/RESULTS/WEIGHTED/out_pred_all.csv")
...
#results.to_csv("D:/TESIS_PHD/RICENETPPI/out_pred.csv")
results.to_csv("D:/REPO_GITHUB/ALUMINUM_GENES_CLASSIFICATION/RESULTS/UNWEIGHTED/out_pred_all.csv")
