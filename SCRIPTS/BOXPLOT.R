...
data_LFC1 <- data_LFC1[which(data_LFC1$status==1),]
...
data_LFC1_W <- data_LFC1[which(data_LFC1_W$status==1),]
row.names(data_LFC1_W) <- data_LFC1_W$genes;data_LFC1_W$genes <- NULL

dd <- colnames(data_LFC1)


data_LFC1 <- data_LFC1[,c(3:11)]
data_LFC1_W  <- data_LFC1_W[,c(3:11)]



data_LFC1 <- melt(data_LFC1)
data_LFC1$approach <- "Unweighted"
data_LFC1_W <- melt(data_LFC1_W)
data_LFC1_W$approach <- "Weighted"
...
data_LFC2 <- data_LFC2[which(data_LFC2$status==1),]
...
data_LFC2_W <- data_LFC2_W[which(data_LFC2_W$status==1),]
row.names(data_LFC2_W) <- data_LFC2_W$genes;data_LFC2_W$genes <- NULL

dd2 <- colnames(data_LFC2)


data_LFC2 <- data_LFC2[,c(3:11)]
data_LFC2_W  <- data_LFC2_W[,c(3:11)]



data_LFC2 <- melt(data_LFC2)
data_LFC2$approach <- "Unweighted"
data_LFC2_W <- melt(data_LFC2_W)
data_LFC2_W$approach <- "Weighted"
...
ggexport(p_all,
  filename = paste0("D:/REPO_GITHUB/ALUMINUM_GENES_CLASSIFICATION/INPUTS","/","PROB_VIOLIN.pdf"),
  width = 18,
  height = 25,
  #pointsize = 400,
  res =1000,
